...
if has('gui_running')
    hi Normal guifg=#eeeeee guibg=Grey20
    "hi Normal guifg=#eeeeee guibg=#000000
    hi Cursor guifg=Black guibg=Yellow

    hi LineNr guifg=Grey30 ctermfg=236
    ...
    hi NonText guifg=Grey50 guibg=Grey15 ctermfg=234
    ...
    hi Comment guifg=#ff5c59 ctermfg=240
